...
import presenter.Maze3dCommands.dirCommand.dirResultCommand;
...
public class Maze3dCommands extends CommonCommandsManager {
	...
	public void setCommands() {
		...
		commands.put("generateResult", new generateResult());
	...
	class dirResultCommand implements Command {
		...
		public void doCommand(String[] args) {
			if (args.length >= 6) {
				...
				try {
					...
					//view.println("There is at least one improper dimension. Maze name, number of floors, columns and rows are needed");
				}
			} //else
	...
	class generateResult implements Command{

		@Override
		public void doCommand(String[] args) {//args = maze name
			String name=args[1];
			model.getGenerateResult(name);
		}
