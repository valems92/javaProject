...
/**
 * <h1>GameCharacter</h1>
 * Represent the character in maze. 
 * Draw the character on each move or screen resize.
 * <p>
...
public class GameCharacter {
	...
	/**
	 * <h1>GameCharacter</h1>
	 * Initialize data and images. 
	 * <p>
	 * @param display display to add the character
	 * @param imgPath image path of character (left)
	 * @param flipImgPath image path of character (right)
	 */
	...
	/**
	 * <h1>paint</h1>
	 * On each move or screen resize, paint is called. 
	 * It check if the character is moving right or left and draw the correct image.
	 * <p>
	 * @param e paintEvent of maze widget
