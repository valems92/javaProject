...
/**
 * <h1>ButtonDisplay</h1> A custom widget for buttons in program. Contains an
 * image and text.
 * <p>
 * 
...
public class ButtonDisplay extends Canvas {
    ...
    /**
     * <h1>initWidgets</h1> Create the widgets inside de button. The button
     * contains two labels, one for the image and one for the text.
     * <p>
     * 
     * @param txt
     *            text of button
    ...
    /**
     * <h1>drawBtn</h1> Change button (labels) position to be at the center.
     * Also, if button should be disable, change image and text color.
     * <p>
     * 
     * @param width
     *            bg image width
    ...
    /**
     * <h1>setLabel</h1> Create the button text label and change it font size.
     * <p>
     * 
     * @param txt
     *            text of button
    ...
    /**
     * <h1>setKeyListener</h1> Get a key event, and add it to button
     * <p>
     * 
     * @param keyEvent
     *            key event to add to button
     */
